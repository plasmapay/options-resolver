...
function createResolver() {
  ...
  function getMissingOptions() {
    return (0, _array.difference)(Object.keys(state.required), Object.keys(state.defaults));
  }
  ...
  function resolve() {
    ...
    return new Promise(function (resolve, reject) {
      ...
      var definedDiff = (0, _array.difference)(Object.keys(options), Object.keys(clone.defined));

      if (definedDiff.length) {
        var definedKeys = (0, _collection.sortBy)(Object.keys(clone.defined)).join('", "');
        var diffKeys = (0, _collection.sortBy)(definedDiff).join('", "');
        var _err = 'The option(s) "' + diffKeys + '" do not exist. Defined options are: "' + definedKeys + '"';
        return reject(_err);
      }
      ...
      var requiredDiff = (0, _array.difference)(Object.keys(clone.required), Object.keys(clone.defaults));
      if (requiredDiff.length) {
        var _diffKeys = (0, _collection.sortBy)(requiredDiff).join('", "');
        var _err2 = 'The required options "' + _diffKeys + '" are missing';
        return reject(_err2);
      }
